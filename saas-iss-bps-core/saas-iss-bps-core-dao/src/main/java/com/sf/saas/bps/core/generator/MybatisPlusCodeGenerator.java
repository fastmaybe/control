package com.sf.saas.bps.core.generator;
...
public class MybatisPlusCodeGenerator {
    ...
    //表前缀 和模块名称一致
    private static String TABLE_PRE ="bps_";


    private static String[] tables = {"bps_strategy_match_log"};
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://10.148.246.66:3306/sabps?useUnicode=true&ampcharacterEncoding=utf8&ampallowMultiQueries=true&ampserverTimezone=GMT%2B8");
...
//        String controllerTemplatePath = "/templates/controller.java.vm";
        String baseJavaPackageFile = "/src/main/java/com/sf/saas/bps";
        // mapper.xml
        focList.add(new FileOutConfig(xmlTemplatePath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/saas-iss-bps-core/saas-iss-bps-core-dao/src/main/resources/mapper/"
        ...
        focList.add(new FileOutConfig(entityTemplatePath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/saas-iss-bps-core/saas-iss-bps-core-dao" + baseJavaPackageFile + "/core/dao/entity"
        ...
        focList.add(new FileOutConfig(mapperTemplatePath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/saas-iss-bps-core/saas-iss-bps-core-dao" + baseJavaPackageFile + "/core/dao/mapper"
        ...
        focList.add(new FileOutConfig(serviceTemplatePath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/saas-iss-bps-core/saas-iss-bps-core-service" + baseJavaPackageFile + "/core/service/crud"
        ...
        focList.add(new FileOutConfig(serviceImplTemplatePath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/saas-iss-bps-core/saas-iss-bps-core-service" + baseJavaPackageFile + "/core/service/crud/impl"
