package com.sf.saas.bps.core.service.event.redis.message;

import com.sf.saas.bps.core.common.constans.BpsConstant;
import com.sf.saas.bps.core.service.event.redis.handler.IMessageHandler;
...
public class RedisMessageListener implements MessageListener<MessageBase> {
    ...
    public void onMessage(CharSequence charSequence, MessageBase publishBase) {
        try {
            ...
            MDC.put(BpsConstant.TRACE_ID,traceId);
